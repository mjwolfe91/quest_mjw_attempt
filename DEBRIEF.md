...
Fairly straightforward, no issues.

### Part 3

Initially I wanted to do this with PySpark, but since I wanted to stick with free tier I went with Sagemaker. PySpark struggled to get running, and after I couldn't connect to S3 I gave up and switched to Pandas. As the FAQ mentioned, lots of data quality issues, but once I cleared those it was pretty simple. Notebook and rendered Markdown is available at the reports directory.
